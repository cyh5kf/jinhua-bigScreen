...
class LeftFirst extends PureComponent {
  ...
  render () {
    ...
    return (
      <div onMouseOver={() => this.onHover(1, true)} onMouseOut={() => this.onHover(1, false)} style={{ padding: '10px 30px' }}>
        {/* className={`${styles.leftContent} ${wheelStatus === 1 ? styles.is_active : ''}`} */}
        <div className={IndexStyle.text_title}>劳动关系信访 - 全年累计</div>
        {/* <div className={flex}>
                    <div>
        ...
        <BarBaoXian gct={gct} style={{ width: '100%', height: 159 }} />
      </div>
    )
  }
}
