...
import zhizhen from "../../../../../assets/images/screen/zhi_zhen.svg";
      ...
      <div className={styles.container}>
        <div style={{ marginTop: "-8px" }}>
          <span className={styles.label_text}>
            {wlxx.KPI_NAME ? wlxx.KPI_NAME : "----"}
          </span>
          &nbsp;&nbsp;
          <b className={IndexStyle.numfont}>
            {wlxx.KPI_VALUE ? Math.round(wlxx.KPI_VALUE) : 0}
          </b>
        </div>
        <div className={styles.fa}>
          <div className={styles.ch}>
            <img alt="" id="rotate" src={zhizhen} />
          </div>
        </div>
        <p className={styles.dec}>
          <span>
            <span className={styles.label}>省排名: </span><b className={styles.orange}>{wlxx.全省}</b>/
            {wlxx.省内城市数}
          </span>
        </p>
      </div>
